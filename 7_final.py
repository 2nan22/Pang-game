...
# 화면 타이틀 설정
pygame.display.set_caption("2nan Pang") 
...
image_path = os.path.join(current_path, 'imgs') # images 폴더 위치 반환
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        break # 안쪽 for 문에서 break을 만나면 여기로 진입 가능, 2중 for문을 한번에 탈출 가능
